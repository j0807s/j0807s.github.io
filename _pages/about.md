...
* **High Performance AI Frameworks**: Developed dynamic thread allocation for a multi-tenant GPU [ESL'24].  Enabled hardware support for bitslice representation to process arbitrary low-precision numeric formats [P4]. Developed memory-efficient continual learning [P2, P7].
