...
* **Heterogenous Memory**: Developed a memory oversubscription-aware tensor migration scheduling for a GPU unified storage architecture [P1]. Enabled unified Flash Translation Layer (FTL) with dedicated IOMMUs and the optimized migration scheduler for accelerator using hetergeneous memory [P3]. Analyzed the behavior of a real CXL-based system on datacenter workloads to uncover open challenges in the emerging hardware platform [P5].
